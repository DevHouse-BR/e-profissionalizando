...
<div id="yoo-zoo" class="yoo-zoo <?php echo $css_class; ?> <?php echo $css_class.'-'.$this->category->alias; ?>">
	...
	<?php endif; ?>
	<?php if (($this->params->get('template.show_title') == true) && ($this->params->get('template.show_description') == false) && ($this->params->get('template.show_image') == false)): ?>
	<h1 class="title"><?php echo $this->category->name; ?></h1>
	<hr />
	<?php elseif ($this->params->get('template.show_title') || $this->params->get('template.show_description') || $this->params->get('template.show_image')) : ?>
