...
<div class="faq_category_head"><div class="componentheading">Perguntas Frequentes</div></div>

<?php if ($this->showcats) : ?>
	<div class="fsf_spacer fsf_spacer contentheading">Por favor selecione a categoria</div>
	    	...
	    	<tr><td width='<?php echo $colwidth; ?>' class='fsf_faq_cat_col_first' valign="top">
				<div class='faq_category'>
					...
					<div class='faq_category_head'>
						...
						<A class="fsf_highlight" href='<?php echo JRoute::_( '&limitstart=&catid=' . 0 );?>'>Todas Perguntas</a>
						<?php if ($this->curcatid == 0) : ?></b><?php endif; ?>
					</div>
					<div class='faq_category_desc'>Veja todas as perguntas frequentes.</div>
				</div>
