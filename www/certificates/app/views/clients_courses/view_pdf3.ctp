...
$less = 23;
$more = 35;
$tcpdf->SetTextColor(190, 190, 190);
...
$tcpdf->Cell(0,14, utf8_encode('concluiu com êxito, através do Inglês Curso Escola de Idiomas Ltda.'), 0,1,'J');
$tcpdf->Cell(0,14, 'CNPJ: 09.095.740/0001-23, o curso de ' . $course['Course']['nome'], 0,1,'J');
...
$tcpdf->Cell(0,14, $formatacao->data($ultimo[0]['clients_courses']['conclusao']), 0,1,'R');
...
$Email->Body .= "Segue em anexo seu certificado de conclusão.";
$Email->Send();
