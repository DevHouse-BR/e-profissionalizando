...
{/foreach}
</select></td><td width="15%" class="fieldlabel">{$_ADMINLANG.fields.clientid}</td><td class="fieldarea"><input type="text" name="userid" size="10" value="{$userid}" /></td></tr>
...
{if $relatedproduct}
<table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
<tr><td class="fieldlabel" width="15%">{$_ADMINLANG.fields.product}</td><td class="fieldarea"><a href="clientshosting.php?userid={$userid}&hostingid={$relatedproduct.id}" target="_blank">{$relatedproduct.name}</a></td><td class="fieldlabel" width="15%">{$_ADMINLANG.fields.regdate}</td><td class="fieldarea">{$relatedproduct.regdate}</td></tr>
<tr><td class="fieldlabel">{$_ADMINLANG.fields.domain}</td><td class="fieldarea"><a href="http://{$relatedproduct.domain}" target="_blank">{$relatedproduct.domain}</a></td><td class="fieldlabel" width="15%">{$_ADMINLANG.fields.nextduedate}</td><td class="fieldarea">{$relatedproduct.nextduedate}</td></tr>
<tr><td class="fieldlabel">{$_ADMINLANG.fields.userpass}</td><td class="fieldarea">{if $relatedproduct.username} {$relatedproduct.username} / {$relatedproduct.password} {$relatedproduct.loginlink}{/if}</td><td class="fieldlabel">{$_ADMINLANG.fields.status}</td><td class="fieldarea">{$relatedproduct.status}</td></tr>
</table>
{/if}

{if $relateddomain}
<table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
<tr><td class="fieldlabel" width="15%">{$_ADMINLANG.fields.domain}</td><td class="fieldarea">{$relateddomain.domain}</td><td class="fieldlabel" width="15%">{$_ADMINLANG.fields.nextduedate}</td><td class="fieldarea">{$relateddomain.nextduedate}</td></tr>
<tr><td class="fieldlabel">{$_ADMINLANG.fields.registrar}</td><td class="fieldarea">{$relateddomain.registrar}</td><td class="fieldlabel">{$_ADMINLANG.domains.regperiod}</td><td class="fieldarea">{$relateddomain.regperiod} {$_ADMINLANG.domains.years}</td></tr>
<tr><td class="fieldlabel">{$_ADMINLANG.orders.ordertype}</td><td class="fieldarea">{$relateddomain.ordertype}</td><td class="fieldlabel">{$_ADMINLANG.fields.status}</td><td class="fieldarea">{$relateddomain.status}</td></tr>
</table>
{/if}
