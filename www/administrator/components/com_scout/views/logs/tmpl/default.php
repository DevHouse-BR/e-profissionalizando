	...
	<table class="adminlist" style="clear: both;">
		<thead>
            <tr>
                ...
                <th style="width: 50px;">
                    <?php echo ScoutGrid::sort( 'Site', "scope.client_id", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 125px;">
                    <?php echo ScoutGrid::sort( 'Scope', "scope.scope_name", @$state->direction, @$state->order ); ?>
                </th>                
                <th style="text-align: left;">
                	<?php echo ScoutGrid::sort( 'Subject', "subject.subject_name", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
    	            <?php echo ScoutGrid::sort( 'Verb', "verb.verb_name", @$state->direction, @$state->order ); ?>
                </th>
                <th style="text-align: left;">
                    <?php echo ScoutGrid::sort( 'Object', "object.object_name", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
            ...
            <tr class="filterline">
                ...
                <th style="text-align: left;">
                    <?php echo ScoutSelect::scope( @$state->filter_scopeid, 'filter_scopeid', $attribs, 'filter_scopeid', true, 'Select Scope' ); ?>
                </th>
                <th style="text-align: left;">
                    <?php echo ScoutSelect::subject( @$state->filter_subjectid, 'filter_subjectid', $attribs, 'filter_subjectid', true, 'Select Subject' ); ?>
                </th>
                <th style="text-align: left;">
                    <?php echo ScoutSelect::verb( @$state->filter_verbid, 'filter_verbid', $attribs, 'filter_verbid', true, 'Select Verb' ); ?>
                </th>
                <th style="text-align: left;">
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
                ...
                <td style="text-align: center;">
                    <?php echo JHTML::_( 'date', $item->datetime, '%a, %d %b %Y, %I:%M%p' ); ?>
                </td>
			</tr>
			<?php $i=$i+1; $k = (1 - $k); ?>
			<?php endforeach; ?>
