...
class ElementGooglemaps extends Element {
	...
	*/
	public function edit() {
		...
		// fields
		$location = JHTML::_('control.text', 'elements['.$this->identifier.'][location]', $this->_data->get('location'), 'maxlength="255"');
		$popup    = '<textarea name="elements['.$this->identifier.'][popup]" cols="18" rows="5">'.$this->_data->get('popup').'</textarea>';

		// create html
		$html  = '<table>';
		$html .= JHTML::_('element.editrow', JText::_('Location'), $location);
		$html .= JHTML::_('element.editrow', JText::_('Popup'), $popup);
		$html .= '</table>';
