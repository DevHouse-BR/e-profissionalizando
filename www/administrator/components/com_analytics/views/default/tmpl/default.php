...
JToolBarHelper::title(JText::_('Analytics'), 'generic.png');
JToolBarHelper::preferences('com_analytics');
?>
...
<?php endif; ?>
      ...
      <p class="submit">
        ...
        <input type="submit" name="Logout" class="button-primary" value="Logout" />
      </p>
...
.ie_layout {
  ...
  <div style="padding-bottom: 5px;">
    Page Views <?php echo $start_date ?> to <?php echo $end_date ?> <br/>
  ...
  <div style="position: relative; padding-top: 5px;" class="ie_layout">
    <h4 style="position: absolute; top: 6px; left: 10px; background-color: #fff; padding-left: 5px; padding-right: 5px;">Base Stats </h4>
  ...
  <div style="position: relative; padding-top: 5px;" class="ie_layout">
    <h4 style="position: absolute; top: 6px; left: 10px; background-color: #fff; padding-left: 5px; padding-right: 5px;">Extended Stats</h4>
    <hr style="border: solid #eee 1px"/><br/>
  </div>
    ...
    <div id="extended-stats">
      <div style="text-align: left; font-size: 90%;">
        <div style="width: 50%; float: left;">
          ...
          <h4 class="heading"><?php echo 'Top Pages'; ?></h4>
