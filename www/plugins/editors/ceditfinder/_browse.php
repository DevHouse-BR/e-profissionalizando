...
<form action="" method="post" name="EditImage">
  <table cellspacing="0" cellpadding="5">
    <tr>
      <td>Filename:</td>
      <td><input name="Name" type="text" value="<?php echo $filename; ?>" /></td>
    </tr>
    <tr>
      <td>Size:</td>
      <td><input name="width" type="text" id="width" value="<?php echo $image->getWidth(); ?>" size="6" />px by 
          <input name="height" type="text" id="height" value="<?php echo $image->getHeight(); ?>" size="6" />px<br />
          <input name="chkConstrainProportions" type="checkbox" id="chkConstrainProportions" value="yes" />
...
?>
<form action="" method="post" name="CreateFolder"><p class="imagefolderadd">
  <input name="newfolder" type="text" maxlength="100" id="newfolder" />
  <input type="submit" name="submit" id="submit" value="Create Folder" />
  <input name="folder" type="hidden" id="folder" value="<?php echo $folder; ?>" /></p>
</form>
<?php
	}
...
<form action="" method="post" enctype="multipart/form-data" name="UploadImage">
  <p class="uploadimage">
    ...
    <input type="submit" name="submit" id="submitimage" value="Add Image" />
  <input name="folder" type="hidden" id="folder" value="<?php echo $folder; ?>" /></p>
</form>
<?php
	}
