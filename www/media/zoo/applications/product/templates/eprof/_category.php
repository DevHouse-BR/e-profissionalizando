...
<?php if ($category) : ?>
	...
	<div style="padding-left:3px; padding-right:3px; padding-top:2px; padding-bottom:2px; border:solid 1px #c8cbcd; margin-bottom:2px; background-color:#eeeff0">
		<a style="margin:0px" class="teaser-image" href="<?php echo $link; ?>" title="<?php echo $category->name; ?>">
