...
$mensagem_final   = "<h3>Solicitação de Certificado:</h3> ";
$mensagem_final  .= "<b>Nome: </b>";
$mensagem_final  .= $nome;
$mensagem_final  .= "<BR>";
$mensagem_final  .= "<BR>";
$mensagem_final  .= "<b>Empresa: </b>";
$mensagem_final  .= $empresa;
$mensagem_final  .="<BR>";
$mensagem_final  .= "<b>Endereço: </b>";
$mensagem_final  .= $endereco; $mensagem_final  .= "<b>Cidade: </b>"; $mensagem_final  .= $cidade; $mensagem_final  .= "<b>Estado: </b>"; $mensagem_final  .= $estado;
$mensagem_final  .="<BR>";
...
$mensagem_final  .="<BR>";
$mensagem_final  .= "<b>Bairro: </b>"; $mensagem_final  .= $bairro; $mensagem_final  .= "<b>CEP: </b>"; $mensagem_final  .= $cep;
